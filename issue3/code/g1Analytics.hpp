...
class G1Analytics: public CHeapObj<mtGC> {
  ...
  TruncatedSeq* _total_pause_time_ms_seq;
...
// 在src/hotspot/share/gc/g1/g1Policy.cpp类的update_gc_pause_time_ratios方法中被调用
  ...
  void report_total_pause_time_ms(double total_pause_time_ms);
  ...
  TruncatedSeq* total_pause_time_ms() const;

  double predict_total_pause_time_ms() const;
