...
static double total_pause_time_ms_defaults[] = {
...
G1Analytics::G1Analytics(const G1Predictions* predictor) :
    ...
    _total_pause_time_ms_seq(new TruncatedSeq(TruncatedSeqLength)),
  ...
  _total_pause_time_ms_seq->add(total_pause_time_ms_defaults[index]);
...
// 预测函数将在src/hotspot/share/gc/g1/g1Policy.cpp的predict_base_elapsed_time_ms()中调用
...
TruncatedSeq* G1Analytics::total_pause_time_ms() const {
    return _total_pause_time_ms_seq;
}
